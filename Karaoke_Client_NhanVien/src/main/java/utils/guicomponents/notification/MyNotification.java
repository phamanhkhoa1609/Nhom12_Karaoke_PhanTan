package utils.guicomponents.notification;
...
public class MyNotification extends javax.swing.JComponent {
    ...
    public MyNotification(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new MyImageIcon("src/main/resources/images/icons/sucess.png"));
            lbMessage.setText("Thành công");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new MyImageIcon("src/main/resources/images/icons/info.png"));
            lbMessage.setText("Thông tin");
        } else {
            lbIcon.setIcon(new MyImageIcon("src/main/resources/images/icons/warning.png"));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new MyImageIcon("src/main/resources/images/icons/sucess.png")); // NOI18N
        ...
        cmdClose.setIcon(new MyImageIcon("src/main/resources/images/icons/close.png")); // NOI18N
