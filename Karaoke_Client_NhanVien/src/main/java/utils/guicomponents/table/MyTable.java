...
public class MyTable extends JTable {
    ...
    public void setColumnCenterAndCellAlign(Map<Integer, Integer> dsAlign) {
    	for (int i = 0; i < this.getColumnCount(); i++) {
			setColumnAlignment(i, SwingConstants.CENTER);
		}
		for (Map.Entry<Integer, Integer> entry : dsAlign.entrySet()) {
			setCellAlignment(entry.getKey(), entry.getValue());
        }
	}
