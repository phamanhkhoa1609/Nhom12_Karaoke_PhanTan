...
public class MyTimePicker extends javax.swing.JPanel {

    private final SimpleDateFormat formatampm = new SimpleDateFormat("hh:mm");
    ...
    private void initComponents() {
        ...
        cmdAM.setVisible(false);
        cmdPM.setVisible(false);
        timeComponent.set24hour(true);
        bg.setOpaque(false);
