...
public final class MyDateChooser extends javax.swing.JPanel {
    ...
    private final String MONTH_VIETNAMESE[] = {"Tháng một", "Tháng hai", "Tháng ba", "Tháng tư", "Tháng năm", "Tháng sáu", "Tháng bảy", "Tháng tám", "Thang chín", "Tháng mười", "Tháng mười một", "Tháng mười hai"};
    ...
    public void setTextRefernce(JTextField txt) {
        ...
        this.textRefernce.setFocusable(false);
    ...
    private void initComponents() {
        ...
        cmdForward.setIcon(new MyImageIcon("src/main/resources/images/icons/forward.png")); // NOI18N
        ...
        cmdPrevious.setIcon(new MyImageIcon("src/main/resources/images/icons/previous.png")); // NOI18N
