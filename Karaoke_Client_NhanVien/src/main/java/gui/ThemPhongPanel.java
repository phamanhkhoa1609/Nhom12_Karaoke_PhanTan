...
public class ThemPhongPanel extends MyPanel implements ActionListener, KeyListener {
	...
	public void KhoiTaoGiaoDien() {
		this.phongIDAO = clientIDAO.getPhongIDAO();
		...
		lblTieuDe.setText("Thêm Phòng");
		add(lblTieuDe, "cell 0 0 2 1,alignx center");

		JLabel lblHinhAnhID = new JLabel("Hình Ảnh");
		...
		txtPublicIDPhong = new JTextField();
		...
		btnChonHinh.setFont(new Font("Tahoma", Font.PLAIN, 15));
		add(btnChonHinh, "flowx,cell 0 3,grow");
		btnChonHinh.addActionListener(this);

		lblHinhPhong = new JLabel();
		lblHinhPhong.setIcon(new MyImageIcon("src/main/resources/images/icons/phongkhonganh.png", 360, 270, 0));
		...
		txtMaPhong = new JTextField("ID sẽ được tạo tự động");
		...
		spnGiaPHong = new JSpinner(new SpinnerNumberModel(0L, 0L, null, 10000));
		...
		add(lblKiemTraNhapLieu, "cell 0 14 2 1,alignx leading,growy");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnThem) && kiemTraRangBuoc()) {
